...
CREATE TABLE `purchaseitem` (
  ...
  KEY `purid` (`purid`),
  KEY `pid` (`pid`),
  CONSTRAINT `purchaseitem_ibfk_1` FOREIGN KEY (`purid`) REFERENCES `purchase` (`id`),
  CONSTRAINT `purchaseitem_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `tbl_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sales_product` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`),
  CONSTRAINT `sales_product_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `tbl_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-10  8:40:07
